...
class Board
  ...
  def put_on_board(row,column,letter)
    ...
    else # adds an O to the cell at row position (row) and column (column) each numbered from 0 to 2
...
class EndOfGame
  ...
  #the next method checks if the game is over based on the specific
